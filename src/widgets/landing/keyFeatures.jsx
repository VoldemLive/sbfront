...
const features = [
  {
    ...
    description: "Record and organize your dreams effortlessly.",
  },
  {
    icon: (
      <svg
    ...
    description: "Get insights based on Jungian and Freudian perspectives.",
  },
  {
    icon: (
      <svg
    ...
    description: "Understand yourself better through dream analysis.",
  },
  {
    icon: (
      <svg
    ...
    title: "Token System",
    description: "Earn tokens for in-depth interpretations.",
  },
]
